                ...
                <div class="reg-form-container">
                    ...
                    <div class="reg-options">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="{{url('admin/login')}}" data-toggle="tab">Login</a></li>
                        </ul><!--Tabs End-->
                    </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="register">
                            ...
                            <!--Register Form-->
                            <form action="{{route('register.store')}}" name="registration_form" id='registration_form' class="form-inline" method="post">
                                @csrf
                                <div class="row">
                                    <div class="form-group col-xs-6">
                                        <label for="firstname" class="sr-only">First Name</label>
                                        <input id="firstname" class="form-control input-group-lg" type="text" name="name" title="Enter first name" placeholder="First name"/>
                                    </div>
                                    <div class="form-group col-xs-6">
                                        <label for="lastname" class="sr-only">Last Name</label>
                                        <input id="lastname" class="form-control input-group-lg" type="text" name="last" title="Enter last name" placeholder="Last name"/>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-6">
                                        ...
                                        <select class="form-control" id="country" name="country">
                                            ...
                                            <option value="CUW">Cura\E7ao</option>
                            ...
                            <br><!--Register Now Form Ends-->
                            <p><a href="{{url('admin/login')}}">Already have an account?</a></p>
