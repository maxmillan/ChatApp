...
<!-- Mirrored from mythemestore.com/friend-finder/edit-profile-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2019 10:47:53 GMT -->
<head>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="profile-info">
                            <a href="#"><img src="{{asset('/uploads/avatar/softdev.jpeg')}}" alt="" class="img-responsive profile-photo"/></a>
                ...
                <div class="col-md-7">
                    ...
                    <div class="edit-profile-container">
                        ...
                        <div class="edit-block">
                            <form action="{{url('admin/userUpdate', $user->id)}}" name="basic-info" id="basic-info" class="form-inline" enctype="multipart/form-data" method="post">
                                @csrf
                                <div class="row">
                                    <div class="form-group col-xs-6">
                                        <label for="firstname">First name</label>
                                        <input id="firstname" class="form-control input-group-lg" type="text" name="name" title="Enter first name" placeholder="First name" value={{$user->name}} />
                                    </div>
                                    <div class="form-group col-xs-6">
                                        <label for="lastname" class="">Last name</label>
                                        <input id="lastname" class="form-control input-group-lg" type="text" name="last" title="Enter last name" placeholder="Last name" value={{$user->last}} >
                                    </div>
                                </div>
                                <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div id="filterDate2">
                                                        ...
                                                        <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                            <input  type="text" name="date" class="form-control" placeholder="dd.mm.yyyy" value="{{$user->date}}">
