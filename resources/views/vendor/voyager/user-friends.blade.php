                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <ul class="list-inline profile-menu">
                            <li><a href="{{url('admin/user-timeline')}}">Timeline</a></li>
                            <li><a href="timeline-about.html">About</a></li>
                            <li><a href="timeline-album.html">Album</a></li>
                            <li><a href="{{url('admin/user-friends')}}" class="active">Friends</a></li>
                        </ul>
                ...
                <div class="col-md-7">
                    ...
                    <div class="friend-list">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="friend-card">
                                    <img src="{{asset('images/covers/3.jpg')}}" alt="profile-cover" class="img-responsive cover" />
                                    <div class="card-info">
                                        <img src="{{asset('images/users/user-4.jpg')}}" alt="user" class="profile-photo-lg" />
                                        <div class="friend-info">
                                            <a href="#" class="pull-right text-green">My Friend</a>
